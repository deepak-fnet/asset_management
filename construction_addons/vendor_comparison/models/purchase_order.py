...
class PurchaseOrder(models.Model):
    ...
    rfq_id = fields.Many2one(
        'purchase.order', string='Source RFQ', copy=False,
        help="The original multi-vendor RFQ this confirmed order was split/created from, "
             "when raised through vendor comparison.")
