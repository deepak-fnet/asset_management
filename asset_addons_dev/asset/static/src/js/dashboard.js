...
export class MyAssetDashboard extends Component {
...
MyAssetDashboard.template = "asset.asset_dashboard_template";

registry.category("actions").add("asset_dash_tag", MyAssetDashboard);
