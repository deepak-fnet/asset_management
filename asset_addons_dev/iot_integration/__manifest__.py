...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'iot_integration/static/src/css/iot_location_map_field.css',
            'iot_integration/static/src/xml/iot_location_map_field.xml',
            'iot_integration/static/src/js/iot_location_map_field.js',
        ],
    },
    'installable': True,
    'application': True,
